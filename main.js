...
console.log(error);
        ...
        console.log(results);
drawing_label=results[0].label;
drawn_sketch=drawing_label;
drawing_confidence=Math.floor((results[0].confidence)*100)+ "%";
document.getElementById("sketch").innerHTML="Your Sketch: " + drawing_label;
document.getElementById("confidence").innerHTML="confidence: "+drawing_confidence;
    }
}
function checkSketch() {
    ...
    if (timer_counter>800){
        ...
        // window.location="time_over.html"
    }
